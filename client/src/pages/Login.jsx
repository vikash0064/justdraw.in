        ...
        <div className="excali-card-wrapper">
          ...
          >
            ...
            <div className="excali-card-header">
              <span className="excali-badge-sub">WELCOME BACK</span>
              <h1 className="excali-card-title">Hi there!</h1>
              <p className="excali-card-subtitle">Choose how you want to sign in.</p>
            </div>
            ...
            <div className="excali-social-section">
              ...
              <div className="excali-social-grid">
                ...
                {/* 3. Google (Highlighted with "Last used" pill) */}
                <button
                  type="button"
                  className="excali-social-btn highlight-google"
                  onClick={handleGoogleLogin}
                  aria-label="Sign in with Google"
                  title="Sign in with Google (Last used)"
                >
            ...
            <form onSubmit={handleEmailSubmit} className="excali-auth-form">
              ...
              <button
                type="submit"
                className={`excali-btn-primary ${isPasswordFormOpen ? 'accent-purple' : ''}`}
                disabled={loading}
              >
                {loading ? (
                  ...
                  <span>Passwordless sign-in with email</span>
                )}
              </button>
            </form>
            ...
            <div className="excali-switch-row">
              <Link to="/register" className="excali-switch-link">
